  ...
  return (
    <section className="relative min-h-[90vh] flex items-center justify-center bg-gradient-to-br from-slate-50 via-cyan-50/30 to-blue-50/50 dark:from-slate-900 dark:via-cyan-900/30 dark:to-blue-900/40 overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute -top-16 -right-16 w-72 h-72 rounded-full opacity-20 dark:opacity-12 bg-gradient-to-br from-cyan-400 via-blue-500 to-purple-600 blur-3xl shadow-[0_0_100px_rgba(6,182,212,0.3)]" />
        <div className="absolute -bottom-16 -left-16 w-72 h-72 rounded-full opacity-20 dark:opacity-12 bg-gradient-to-br from-emerald-400 via-teal-500 to-cyan-600 blur-3xl shadow-[0_0_100px_rgba(16,185,129,0.3)]" />
        <div className="absolute top-1/3 left-1/4 w-64 h-64 rounded-full opacity-15 dark:opacity-8 bg-gradient-to-br from-purple-400 via-pink-500 to-rose-600 blur-3xl shadow-[0_0_80px_rgba(168,85,247,0.2)]" />
        
        {/* Simplified floating particles for better performance */}
        {[...Array(6)].map((_, i) => (
          <div
            key={i}
            className="absolute w-2 h-2 bg-gradient-to-r from-cyan-400 to-blue-500 dark:from-cyan-300 dark:to-blue-400 rounded-full shadow-[0_0_20px_rgba(6,182,212,0.5)] opacity-60"
            style={{
        ...
        >
          ...
          >
            <div className="flex items-center justify-center gap-4 mb-4">
              <div className="text-cyan-500 dark:text-cyan-400 drop-shadow-2xl">
          ...
          >
   اكتشف عالم المواد العربية الأزهرية بطريقة حديثة ومتطورة 11111111111111
            <br />
